...
model_name = "ZF_DVIADETDB_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ZFNet/DVIADETDB/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ZFNet/DVIADETDB/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ZFNet/DVIADETDB/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "/IMAGESETS/DVIADetDB/DVIAdevkit/results_ssd_zf/DVIADETDB/{}".format(job_name)
...
det_out_param = {
    ...
    'share_location': share_location,
    'background_label_id': background_label_id,
    'nms_param': {'nms_threshold': 0.35, 'top_k': 400},
    'save_output_param': {
...
ZFNetBody(net, from_layer='data', fully_conv=True, reduced=REDUCED, dilated=True,
